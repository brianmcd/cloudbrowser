...
(function (onServer) {
    ...
    */
    UpdateEngine.prototype.insertElementNode = function (args) {
        var envID       = args['envID']       || throw new Error('Missing parameter');
        var parentEnvID = args['parentEnvID'] || throw new Error('Missing parameter');
        var name        = args['name']        || throw new Error('Missing parameter');
    ...
    */
    UpdateEngine.prototype.insertTextNode = function (args) {
        var envID       = args['envID']       || throw new Error('missing parameter');
        var parentEnvID = args['parentEnvID'] || throw new Error('missing parameter');
        var data        = args['data']        || throw new Error('missing parameter');
        var attributes  = args['attributes'];

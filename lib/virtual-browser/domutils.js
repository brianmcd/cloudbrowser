...
exports.depthFirstSearch = function (visit) {
    if (this.document == undefined) {
        throw new Error('tried to search an undefined document');
    }
...
exports.getNodes = function (name) {
    switch (name) {
        case 'dfs':
        default:

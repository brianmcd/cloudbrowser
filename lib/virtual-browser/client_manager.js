...
var ClientManager = module.exports = Class.create({
    initialize : function (browser) {
        ...
        self.browser.dom.browser.on('loading', function () {
            ...
            self.queuedCommands = [];
            self.browser.dom.browser.removeAllListeners('DOMModification');
            ...
            self.browser.dom.browser.on('DOMModification', function (command) {
        ...
        self.browser.dom.browser.on('loaded', function () {
            ...
            console.log('Before unshift, LENGTH=' + self.queuedCommands.length);

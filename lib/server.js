    ...
    loadLocal : function (opts) {
        ...
        this.browsers.lookup(sessionID, function (browser) {
            browser.loadFromFile({
                ...
                failure : function () {
                    throw new Error('Error rendering BrowserInstance from HTML file.');
                    // TODO: in production, send a 500 error
                }
            });
        });
    },
    ...
    loadRemote : function (opts) {
        ...
        this.browsers.lookup(req.sessionID, function (browser) {
            browser.loadFromURL({
                ...
                failure : function () {
                    throw new Error('Error rendering BrowserInstance from remote URL.');
                }
            });
        });
    },

...
*/
var BrowserInstance = module.exports = function (envChoice) {
...
BrowserInstance.prototype.dispatchEvent = function (eventInfo) {
    ...
    if (this.envChoice == 'jsdom') {
        ...
        // I'm having to override link clicks here because zombie isn't
        // respecting stopPropagation and preventDefault in the event 
        // handler.
        console.log('fixme');
        if (eventInfo.eventType == 'MouseEvent') {
...
BrowserInstance.prototype.createEnv = function (envChoice) {
    var env = undefined;
    switch (envChoice) {
        case 'jsdom':
            env = new JSDom();

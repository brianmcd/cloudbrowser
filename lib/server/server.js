...
app.get('/', function (req, res) {
    ...
    //      to the text box
    fs.readdir(path.join(process.cwd(), 'html'), function (err, files) {
        //TODO: handle err
...
app.get('/join/:browserid', function (req, res) {
    console.log('Joining: ' + req.params.browserid);
    res.render('base.jade', {browserid : req.params.browserid});
});
...
app.post('/create', function (req, res) {
    ...
    var runscripts = (browserInfo.runscripts && (browserInfo.runscripts === 'yes'));
